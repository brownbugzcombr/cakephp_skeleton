...
class MediaController extends AppController {
    ...
    function imageUpload() {
        define('NICUPLOAD_PATH', WWW_ROOT . 'upload' . DS . 'posts'); // Set the path (relative or absolute) to
        define('NICUPLOAD_URI', '/upload/posts/');   // Set the URL (relative or absolute) to
