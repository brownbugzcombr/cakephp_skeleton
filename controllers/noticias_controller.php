...
class NoticiasController extends PostsController {
    ...
    function index() {
        ...
        $this->paginate['Post']['conditions']['tipo'] = 1; //1 noticia, 2 blog, 3 livro
        $this->paginate['Post']['limit'] = 25;
        $this->set('dados', $this->paginate('Post'));
        $categorias = $this->Post->find('list', array('fields' => array('id', 'categoria_id'), 'conditions' => array('tipo' => '1')));
    ...
    function admin_index() {
        $this->paginate['Post']['conditions'] = array('tipo' => '1'); //1 noticia, 2 blog
        parent::admin_index();
    }

    function admin_add($post_id = null) {
        if (isset($this->data)) {
            $this->data['Post']['tipo'] = '1';
        }
