        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $d['Comentario']['id']; ?></td>
                    <td><?php echo $d['Comentario']['texto']; ?></td>
                    <td><?php echo date('d/m/Y', strtotime($d['Post']['created'])); ?></td>
                    <td class="delete">
					<?php echo $this->Html->link('Deletar',array('controller' => 'comentarios', 'action' => 'del', $d['Comentario']['id']),array(),"Tem certeza que deseja deletar este registro?");?>
                    </td>
                </tr>
