    ...
    CKEDITOR.dialog.add('flash',function(i){
        ...
        return{
            ...
            onShow:function(){
                ...
                l=new CKEDITOR.dom.element('video',i.document);
                ...
                if(n&&n.data('cke-real-element-type')&&n.data('cke-real-element-type')=='flash'){
                    ...
                    if(o.getName()=='cke:video'){
                        p=o;
                        var s=p.getElementsByTag('video','cke');
                    ...
                    }else if(o.getName()=='cke:video')q=o;
                    z.objectNode=p;
                    z.embedNode=q;
            ...
            onOk:function(){
                ...
                if(!x.fakeImage){
                    if(j){
                        n=CKEDITOR.dom.element.createFromHtml('<cke:video></cke:video>',i.document);
                        var q={
                            url:CKEDITOR.tools.htmlEncode(l.getAttribute('src'))
                        };
